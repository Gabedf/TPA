...
| Atividade | Membro Responsável | 
| :--- | :---: |
| Criação classe ListaEncadeada | Gabriel Leite Fonseca |
| Criação classe ListaEncadeada | César Augusto Bispo Santos |
| Implementação Programa que use Biblioteca| César Augusto Bispo Santos |

#### Responsabilidades atividades
github: https://github.com/Gabedf/TPA/tree/main/Listas/src
...
# **4 - Análise ArrayList e LinkedList**
## 4.1 - LinkedList
...
| Pesquisar (inexistente) | ArrayList (10,91 ms) | ListaEncadeada (62,88 ms) | LinkedList (64,71 ms) |
| Remover (último elemento) | ArrayList (11,46 ms) | ListaEncadeada (60,65 ms) | LinkedList (65,83 ms) | 
